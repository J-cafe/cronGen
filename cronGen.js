...
(function ($) {
    ...
    $.fn.extend({
        cronGen: function () {
            ...
            $(yearlyOption1).append("&nbsp;&nbsp");
            $(yearlyOption1).append('<select id="MonthsOfYear" class="months" style="width: 50px"></select>');
			$(yearlyOption1).append("&nbsp;&nbsp");
